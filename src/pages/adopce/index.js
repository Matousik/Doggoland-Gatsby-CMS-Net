        ...
        <section className="section">
          <div className="container">
            <div className="column is-10 is-offset-1 clanek">
              ...
              <p className="mb-6">U každého našeho zvířátka je zveřejněné telefonní číslo, na kterém čeká jedna z našich kolegyň. O zvířátku Vám řekne více informací, které se do inzerátu nevešly, a především se vyptá na více informací a podmínkách, které zvířátku můžete nabídnout.</p>
              <h3 className="">2. Návštěva zvířátka</h3>
              <p className="">Pokud při telefonátu společně zhodnotíme, že by se zvířátko, o kterého máte zájem, skvěle do Vaší rodiny hodil, tak Vás pozveme na návštěvu za zvířátkem. Návštěva probíhá vždy v dočasném domově, kde zvířátko žije. Díky tomu zvířátka uvidíte v klidném domácím prostředí, kde je zvyklý. Po domluvě s dočaskovou tetou společně můžete jít i na procházku, kde uvidíte, jak se zvířátko chová i na veřejnosti.</p>
              <p className="">Chtěli bychom apelovat na jednu věc. Nebojte se ptát! Všechny dotazy jsou správné! Vybíráte si člena rodiny a máte v tuto chvíli vedle sebe člověka, který jej zná naprosto nejlépe. Zvířátka máme v dočasné péči často několik měsíců, než je plně připravíme do nového domova. Díky tomu je známe opravdu dobře.</p>
              <h3 className="">3. Předadopční kontrola a předání zvířátka</h3>
              <p className="">Návštěva dopadla skvěle a se zvířátkem jste si rozuměli. Teď už se blížíme k jistému finále. Tato poslední část adopce se liší především dle toho, kde bydlíte.</p>
              <h4 className="">První varianta</h4>
              <p className="">Bydlíte do cca 100 km od dočaskové tety? V tomto případě sbalíme zvířátka, připravenou adopční smlouvu a přijedeme se k Vám domů podívat. Nejedná se o žádnou kontrolu, jak máte doma naklizeno! 😊 Chceme pouze vidět v jakých podmínkách bude zvířátko bydlet a zdali nám nebylo něco podstatného zatajeno.</p>
              ...
              <p className="">Adopční smlouvy se není třeba obávat, jsou zde zahrnuty podmínky adopce. Mezi ty patří například souhlas s budoucí poadopční kontrolou, zasílání fotografií, informací o Vašem soužitím se zvířátkem atd.</p>
              <p className="">Adopční poplatek se odvíjí od staří zvířátka, jeho zdravotního stavu a především dle úrovně jeho výcviku. Se zvířátky trénujeme základní poslušnost, socializujeme je a zajišťujeme nadstandardní veterinární ošetření. Zvířátka od nás odchází vždy očkovaní, čipovaní (se zaregistrovaným čipem), odčervení, kastrovaní (pokud k tomu mají odpovídající věk). Pokud mají další nadstandardní vyšetření (RTG, vyšetření krve, moči…), tak se výsledné zprávy přidávají k adopční smlouvě. Do nového domova naši svěřenci dostávají i startovací balíček, kde je krmení minimálně na jeden týden a produkty našich partnerů. Výše adopčního poplatku se pohybuje od 3 000 do 10 000 Kč.</p>
              <h3 className="">5. První dny doma s zvířátkem</h3>
              <p className="">A máme tu finále. První dny s novým psím parťákem nemusí být nejjednodušší. Vždy je třeba čas. Pokud by se Vám jakékoliv chování zvířátka nezdálo, nebo byste si nebyli jisti s jakoukoliv situací, tak se na nás můžete vždy obrátit! Jak na dočaskovou tetu, tak na vedení spolku. Vždy jsme tu pro Vás. Hned první den adopce dostanete pozvánku i do naší soukromé skupinky pro rodiny s adoptovanými zvířátky. Za fotky a informace o tom, jak se Vám s novým parťákem daří, budeme rádi. 😊</p>
            </div>
         </div>
      </section>
      </Layout>
